...
@section('body-append')
    ...
    <script>
		...
		$(function(){
			renderTable('{!! route('admin.partner.data') !!}',
			    [
			        { data: 'id', name: 'id', searchable: false },
			        { data: 'name', name: 'name'},
			        { data: 'logo', orderable: false, name: 'logo'},
		    	...
		    	createdRow: function ( row, data, index ) {
		    		...
		    		$('td',row).eq(2).html('<img class="img-thumbnail" src="'+laroute.route('image.resize', {file:data.logo,w:36,h:36})+'"/>');
            ...
            <div class="ibox float-e-margins" style="border-top:0">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ route('admin.partner.create') }}" class="btn btn-success btn-xs create-link"> <i class="fa fa-plus"></i> {{trans('repositories.create')}}</a>
                    </div>
                </div>
