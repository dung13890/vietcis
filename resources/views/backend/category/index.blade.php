                        ...
                        <ol class="dd-list">
                            ...
                            <li class="dd-item">
                                <div class="dd-handle">
                                    ...
                                    <span class="label label-info"><i class="fa fa-cog"></i></span> <a href="{{route('admin.category.show', $category->id)}}">{{$category->name}}</a>
                                </div>
                                    ...
                                    @foreach($category->children as $children)
                                        <li class="dd-item">
                                            <div class="dd-handle">
                                                ...
                                                <span class="label label-info"><i class="fa fa-cog"></i></span> <a href="{{route('admin.category.show', $children->id)}}">{{$children->name}}</a>
                                            </div>
